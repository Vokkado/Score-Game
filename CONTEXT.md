...
100 productos, rango 6-100, mediana 39, con presencia en las cinco decenas.
**69 sin ninguna alerta.** Las alertas restantes: 14 penalizan sin exceso visible,
12 sin nutrientes que mostrar, 5 pobreza discutible, 5 muy amortiguados.

Cada producto tiene un párrafo de justificación escrito a mano desde su desglose
real (231 caracteres promedio), en `justifications.json`.

**Falta:** revisión humana de `revision.csv` (marcar columna `ok`, decidir marcas
no reconocibles) y las decisiones de la sección 6.

## 8. Checklist del stand
